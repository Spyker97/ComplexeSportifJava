...
import complexesportifJava.services.ServiceCommande;
...
alert.showAndWait();
    ...
    public void afficher_com()
    {
        ...
        try {
            while(resultset.next()){
                ...
                p1.setPayement(resultset.getString("payment"));
   ...
   @FXML
    void ajouter_com(ActionEvent event) throws MessagingException {
       ServiceCommande ps= new ServiceCommande();
...
//         else if(produits.getText().length()!=8)
//{
//    Error("Veuillez saisir correctement le produits");
//}
