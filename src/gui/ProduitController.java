...
import complexesportifJava.entities.Produit;
import java.net.URL;
...
import complexesportifJava.services.ServiceProduit;
...
{Error("Veuillez remplir tous le champs");
    ...
    @FXML
    private void modifier_prod(ActionEvent event) {
        ServiceProduit ps= new ServiceProduit();
        Produit p =new Produit();
     ...
     @FXML
    private void supp_prod(ActionEvent event) throws SQLException{
        ServiceProduit ps= new ServiceProduit();
