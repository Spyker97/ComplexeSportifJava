...
public class CoursController implements Initializable {
    ...
    public void Add_Cours (){    
        ...
        String sql = "insert into Cour (Coach,Num_salle,type)values(?,?,? )";
        try {
            ...
            JOptionPane.showMessageDialog(null, "Cour Add succes");
            UpdateTable();
            search_user();
        } catch (Exception e) {
...
//            String value1 = txt_id.getText();
            ...
            String sql = "update Cour set Coach= '"+value2+"',Num_salle= '"+
                    value3+"',type= '"+value4+"' where Coach='"+value2+"' ";
            pst= conn.prepareStatement(sql);
            pst.execute();
    ...
    public void Delete(){
    conn = MaConnexion.getInstance().getCnx();
    String sql = "delete from Cour where Coach = ?";
        try {
            pst = conn.prepareStatement(sql);
            pst.setString(1, txt_Coach.getText());
            pst.execute();
...
//        col_id.setCellValueFactory(new PropertyValueFactory<Cours,Integer>("id"));
        ...
        listM = MaConnexion.getDataCours();
...
//        col_id.setCellValueFactory(new PropertyValueFactory<Cours,Integer>("id"));
        ...
        dataList = MaConnexion.getDataCours();
